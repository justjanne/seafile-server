...
download_file_path = os.getcwd()+ '/resources/' + download_file_name

resumable_download_file_name = 'resumable_download_file.txt'
resumable_download_file_path = os.getcwd()+ '/resources/' + resumable_download_file_name

resumable_file_name = 'resumable.txt'
chunked_part1_name = 'part1.txt'
chunked_part2_name = 'part2.txt'
chunked_part1_path = os.getcwd()+ '/resources/' + chunked_part1_name
chunked_part2_path = os.getcwd()+ '/resources/' + chunked_part2_name
